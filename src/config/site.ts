...
export const siteConfig = {
  ...
  description: {
    ...
    ar: "تأسست ايجوارش في لشبونة، البرتغال، التي تم اختيارها لموقعها المثالي وفرصها الواعدة للإنشاء والاستثمار. نقدم خدمات شاملة تشمل تأسيس الشركات، والحصول على التراخيص اللازمة للمنتجات والخدمات، والدعم في الاشتراك بالمعارض الأوروبية لتسويق منتجاتكم.",
  },
